...
for k in range(1, 10):
    ...
    clf_weight = neighbors.KNeighborsClassifier(k)
...
plt.plot(X_arr, acc_arr, 'o-', label="distance")
plt.plot(X_arr, acc_my_arr, '+-', label="uniform")
plt.xlabel("K")
plt.ylabel("Error Rate")
plt.title("Compare weight : distance  with  uniform")
plt.legend(loc='best')
plt.savefig("compare_weight_train_text.png")
